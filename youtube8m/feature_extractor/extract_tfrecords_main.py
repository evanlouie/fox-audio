...
def main(unused_argv):
    ...
    for video_file, labels in csv.reader(open(FLAGS.input_videos_csv)):
        ...
        context_features = {
            ...
            FLAGS.video_file_feature_key: _bytes_feature(
                _make_bytes(map(ord, video_file))
            ),
            "mean_"
            + FLAGS.image_feature_key: tf.train.Feature(
    ...
    writer.close()
    print(
        "Successfully encoded %i out of %i videos"

...
if __name__ == "__main__":
    ...
    flags.DEFINE_integer(
        "top_k", 20, "How many predictions to output per video.")
...
def evaluation_loop(video_id_batch, prediction_batch, label_batch, loss,
    ...
    with tf.Session() as sess:
        ...
        if latest_checkpoint:
            ...
            global_step_val = os.path.basename(
...
def evaluate():
    ...
    with tf.Graph().as_default():
        ...
        label_loss_fn = find_class_by_name(
            flags_dict["label_loss"], [losses])()
        ...
        evl_metrics = eval_util.EvaluationMetrics(
            reader.num_classes, FLAGS.top_k)

...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        'Infer. ex: python inference_2dcnn --model_folder="2dcnn/" --wav_file="input/freesound-audio-tagging/shuffled/test/deadpool1_00-01-30.000.wav" --json_filepath="infer.txt"')
    parser.add_argument(
    ...
    parser.add_argument("--wav_file", help="path to a wav file", type=str,
                        default=R'input/freesound-audio-tagging/shuffled/test/deadpool1_00-01-30.000.wav')
    parser.add_argument(
    ...
    def main(unused_argv):
        ...
        jsondata['Label_Data'].update({'label_0':'Other', 'label_1':'gunshot', 'label_2':'pred_label','labelconf_0':df['Other'][0],'labelconf_1':df['Gunshot_or_gunfire'][0],'labelconf_2':prediction[:, 1]})

        ...
        if FLAGS.tf_directory:
            ...
            for filename in os.listdir(subdirectory):
                if filename.endswith(".wav"):
                    ...
                    if os.stat(subdirectory +"/"+ filename).st_size >= 1:
                        ...
                        # Send TF_record_filename and wav file to new function
                        embedding(subdirectory + "/" + filename, tf_recordfile)
                        continue
                    else:
                        print("FILENAME: " + filename + "is an EMPTY File. Ignoring File.")
                        continue
                else:
                    continue
    else:

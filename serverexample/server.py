...
def get_tfrecord():
  print("** get_tfrecord **")
  return embedding_from_wav_data(wav, tfrecord_filename, data_pattern+tfrecord_filename)
...
def get_tfrecord_from_file(wav_filename, wav_data, tfrecord_filename):
  return embedding_from_wav_data(wav_filename, wav_data, data_pattern+tfrecord_filename)
